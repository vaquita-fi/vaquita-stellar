...
//     let contract_address = Address::from_str(e, "CAQCFVLOBK5GIULPNZRGATJJMIZL5BSP7X5YJVMGCPTUEPFM4AVSRCJU");
//     e.register_contract_wasm(&contract_address, MockTokenWASM);
//     let client = MockTokenClient::new(e, &contract_address);
//     client.initialize(admin, &7, &String::from_str(e, "USD Coin"), &String::from_str(e, "USDC"));
...
//     let (token_contract_id, token_client) = create_usdc_token(&env, &admin);
//     let mint_amount = 1000_0000000;
//     token_client.mock_all_auths().mint(&alice, &mint_amount);
// }